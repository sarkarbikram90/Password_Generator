...
with tab1:
    ...
    with col1:
        length = st.slider("Password Length", min_value=8, max_value=50, value=16)
    ...
    if st.button("Generate Password", type="primary"):
        ...
        if not chars:
            ...
            col1.metric("Strength", strength)
            col2.metric("Score", f"{score}/5")
...
with tab2:
    ...
    if password_input:
        strength, score, feedback = check_password_strength(password_input)
